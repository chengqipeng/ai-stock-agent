...
- **多方筹码（有利因素）**：[✅] （提炼4-6个核心数据支撑点，须覆盖技术面、资金面、外部环境，每条必须引用具体数值）
- **空方筹码（不利因素）**：[❌] （提炼4-6个核心风险警示点，须覆盖技术面、资金面、外部环境，每条必须引用具体数值）
...
| 短线情绪 | 15% | 分时均线承接力、尾盘资金动向、五档盘口买卖力量比与大单分布 | /15 |
| 资金筹码 | 15% | 北向资金增减持、机构持仓变化、龙虎榜席位方向、大宗交易折溢价 | /15 |
