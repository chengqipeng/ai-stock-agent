...
请严格按照以下 JSON/Markdown 混合结构输出你的分析结果，语言保持冷峻、专业：

1. **盘面核心定性 (Market Snapshot)**：一句话总结当前所处的多空阶段（如：吸筹洗盘末期、主升加速期、派发破位期）。
2. **量价与指标诊断 (Indicator Analysis)**：
   - 成交量与防守线状态：(详细说明当前量价配合是否健康，高量防线是否安全)
