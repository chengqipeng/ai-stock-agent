...
## 3. 超出市场预期幅度
   ...
   <机构往年预测数据（每季每股收益、市盈率）>
   {historical_forecast_json}
   
   <机构未来预测数据（每季每股收益、市盈率）>
   {future_forecast_json}
...
[最终输出] 请基于以上分析，给出结论：在 C 维度，我们要找的是**“业绩爆款”和“高增引擎”的起爆点。如果一只股票最新一季度 EPS 同比飙升 30% 以上（最好超 50%），且营收同步实现 25% 以上的加速增长，这就是引爆股价主升浪**最强劲的导火索。
"""
