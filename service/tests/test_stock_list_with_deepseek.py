...
async def process_stock(stock, index, total, client, semaphore, lock):
    async with semaphore:
        ...
        try:
            ...
            async with lock:
                with open('stock_score_result/stock_data_list_score_2026_02_07.md', 'a', encoding='utf-8') as f:
...
async def main():
    ...
    tasks = [
        process_stock(stock, index, total, client, semaphore, lock)
