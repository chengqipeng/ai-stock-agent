    ...
    result = {
        ...
        "指标对比": {
            "总市值": {
                ...
                "四分位属性": get_quartile(stock_data.get('f1020', 0), total_count)
            },
            "净资产": {
                ...
                "四分位属性": get_quartile(stock_data.get('f1113', 0), total_count)
            },
            "净利润": {
                ...
                "四分位属性": get_quartile(stock_data.get('f1045', 0), total_count)
            },
            "市盈率(动)": {
                ...
                "四分位属性": get_quartile(stock_data.get('f1009', 0), total_count)
            },
            "市净率": {
                ...
                "四分位属性": get_quartile(stock_data.get('f1023', 0), total_count)
            },
            "毛利率": {
                ...
                "四分位属性": get_quartile(stock_data.get('f1049', 0), total_count)
            },
            "净利率": {
                ...
                "四分位属性": get_quartile(stock_data.get('f1129', 0), total_count)
            },
            "ROE": {
                ...
                "四分位属性": get_quartile(stock_data.get('f1037', 0), total_count)
            }
        }
    }
